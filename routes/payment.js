...
router.post('/binancepay', async (req, res) => {
    ...
    try {
        ...
        const response = await axios.post('https://bpay.binanceapi.com/binancepay/openapi/v1/order', requestBody, { headers });
        res.json(response.data);
    } catch (error) {
        console.error('Error making Binance Pay request:', error.response ? error.response.data : error);
